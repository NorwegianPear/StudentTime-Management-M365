...
> = {
  ...
  holiday_added:            { label: "Holiday Added",      color: "bg-emerald-100 text-emerald-800", icon: "📅" },
  holiday_removed:          { label: "Holiday Removed",    color: "bg-rose-100 text-rose-800",    icon: "📅" },
  holiday_generated:        { label: "Holiday Generated",  color: "bg-cyan-100 text-cyan-800",    icon: "🗓️" },
